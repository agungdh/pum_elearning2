<div class="box box-primary">
  <div class="box-header with-border">
    <h4><strong><font color=blue>HAPUS SISWA</font></strong></h4>
  </div><!-- /.box-header -->

  <!-- form start -->
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('siswa/aksi_hapus'); ?>" >
    <div class="box-body">
    ...
    <div class="form-group">
      <label for="nama">Nama</label>
          <input readonly value="<?php echo $data['siswa']->nama; ?>" type="text" class="form-control" id="nama" placeholder="Isi Nama" name="nama">          
    </div>

    <div class="form-group">
      <label for="angkatan">Angkatan</label>
          <select disabled name="angkatan" class="form-control select2">
                  <?php
