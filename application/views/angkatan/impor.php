<div class="box box-primary">
  <div class="box-header with-border">
    <h4><strong><font color=blue>IMPORT ANGKATAN</font></strong></h4>
  </div><!-- /.box-header -->

  <!-- form start -->
  <form name="form" enctype="multipart/form-data" id="form" role="form" method="post" action="<?php echo base_url('angkatan/aksi_impor'); ?>" >
    <div class="box-body">

    <div class="form-group">
          <a href="<?php echo base_url('berkas/template/angkatan.xls'); ?>" class="btn btn-info">Download template</a>
    </div>
